...
# Cargar variables de entorno desde el directorio donde está este archivo
env_path = Path(__file__).parent / '.env'
load_dotenv(dotenv_path=env_path)

SMTP_HOST = os.getenv('SMTP_HOST', 'grupohg.com.mx')
SMTP_PORT = int(os.getenv('SMTP_PORT', '465'))
SMTP_USER = os.getenv('SMTP_USER')
SMTP_PASSWORD = os.getenv('SMTP_PASSWORD')
EMAIL_FROM = os.getenv('EMAIL_FROM')
EMAIL_FROM_NAME = os.getenv('EMAIL_FROM_NAME', 'SGPME - Grupo HG')
...
Equipo SGPME
        ...
        # Conectar y enviar con SSL (puerto 465)
