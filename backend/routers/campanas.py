...
class CampanaRequest(BaseModel):
    ...
    gasto_actual: Optional[float] = 0.0
...
async def create_campana(user: user_dependency, db: db_dependency, campana_request: CampanaRequest):
    ...
    campana_model = Campanas(
        ...
        gasto_actual=campana_request.gasto_actual,
        auto_objetivo=campana_request.auto_objetivo,
        conversion=campana_request.conversion,
        cxc_porcentaje=campana_request.cxc_porcentaje,
...
async def update_campana(user: user_dependency, db: db_dependency, 
    ...
    print(f"🔧 DEBUG - Actualizando campaña {campana_id}:")
    print(f"   gasto_actual anterior: {campana_model.gasto_actual}")
    print(f"   gasto_actual nuevo: {campana_request.gasto_actual}")
    ...
    campana_model.gasto_actual = campana_request.gasto_actual
    campana_model.auto_objetivo = campana_request.auto_objetivo
    campana_model.conversion = campana_request.conversion
    campana_model.cxc_porcentaje = campana_request.cxc_porcentaje
    ...
    print(f"   gasto_actual guardado: {campana_model.gasto_actual}")
